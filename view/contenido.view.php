...
<html lang="en">
  ...
  <body>
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="#">SenaBook</a></h1>
			<i class="fa fa-arrow-right menu-close"></i>
			<a href="contenido.php">Home</a>
			<a href="services.html">Comunidades</a>
			<a href="portfolio.html">Mi Perfil</a>
			<a href="about.html">About</a>
			<a href="#contact">Contact</a>
			<a href="cerrar.php">Cerrar sesión</a>
			<a href="https://www.facebook.com/SENAColombiaOficial/" target="_blank"><i class="fa fa-facebook"></i></a>
			<a href="https://twitter.com/SENAComunica?lang=es" target="_blank"><i class="fa fa-twitter"></i></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<h1>Senabook</h1>
					<h2>Compartiendo Conocimiento</h2>
	...
	<div id="cf">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<h4>DIRECCIÓN<br/>Cali - Bretaña</h4>
					<br>
					<p>
					...
					<p>
						P: +55 4839-4390<br/>
						F: +55 4333-4345<br/>
						E: <a href="mailto:#">adminsenabook@misena.edu.co</a>
					</p>
